...
<?php
  ...
  include_once("includes/fn/pg_connect.php");
    ...
    $db = pg_connect( "$host $port $dbname $credentials"  );
      ...
      $sql_sel_group  = "SELECT datax_id, datax_name, create_time, update_time, sort, status,branch_id
	                        FROM page_data_manage_datax ".$sql_plus." ORDER BY ".$sortx." datax_id ASC,sort ASC;";;
    ...
    <section class="bg-card text-card-foreground py-16">
      <div class="flex flex-col">
        <div class="py-4 w-full">
          ...
          <tbody>
            <tr>
              <td class="text-right border border-slate-600 w-1/3">Data Name : </td>
        ...
        <table class="table-auto w-4/4 m-auto border border-collapse  border-slate-500 text-center">
          <thead>
            <tr>
              ...
              <th class="border border-slate-600 py-2 px-4">Data name</th>
          ...
          <tbody>
            ...
            ?>
            <tr id="tr_list_<?php echo $rs_sel_group[$i]->datax_id;?>">
              ...
              <td class="border border-slate-600 py-2 px-4"><?php echo $rs_sel_group[$i]->datax_name;?></td>
              <td class="border border-slate-600 py-2 px-4">
                <label class="inline-flex items-center cursor-pointer">
                     <input type="checkbox" value=""  id="status_group_<?php echo $rs_sel_group[$i]->datax_id;?>" class="sr-only peer" <?php if($rs_sel_group[$i]->status=='1'){echo "checked";} ?> onclick="sent_sw_change('<?php echo $rs_sel_group[$i]->datax_id;?>')" /><div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                </label>
              </td>
              <td class="border border-slate-600">
                <a href="manage_data_edit.php?datax_id=<?php echo $rs_sel_group[$i]->datax_id;?>">  
              ...
              <td class="border border-slate-600">
                <button
                  ...
                  type="button"
                  onclick="confirm_del_group('<?php echo $rs_sel_group[$i]->datax_id;?>');"
                >❌</button></td>
            </tr>
            <?php
               }
