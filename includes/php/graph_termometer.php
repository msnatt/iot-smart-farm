...
<div class="w-11/12 xl:w-1/6 max-h-[309px] bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 m-3 float-left justify-center">
<h2 class="text-[#555555]">Termometer1</h2>
  <div id="termometer_cover" class="p-4">	
    <div id="termometer">
