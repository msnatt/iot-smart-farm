...
<div class="w-full xl:w-2/4  bg-white rounded-lg shadow dark:bg-gray-800 float-left">
  <h2>Happiness level during the week:</h2>
  ...
  <div class="container_semi_circle">
    <span class="label-text">Thu, Fri</span>
    <div class="pie-wrapper">
      <div class="arc" data-value="72"></div>
      <span class="score2">72%</span>
    </div>
  </div>
  <div class="container_semi_circle">
    <span class="label-text">Sat, Sun</span>
    <div class="pie-wrapper">
      <div class="arc" data-value="89"></div>
      <span class="score2">89%</span>
    </div>
  </div>

  <div class="legend">
    <p><span class="green"></span>&#62; 80%</p>
    <p><span class="orange"></span>60% - 80%</p>
    <p><span class="red"></span>&#60; 80%</p>
  </div>
