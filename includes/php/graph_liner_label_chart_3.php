...
<div class="w-11/12  2xl:w-[55%] h-[309px] bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 float-left m-3 justify-center">
<h2 class="text-[#555555]">Superchart sensor1</h2>
