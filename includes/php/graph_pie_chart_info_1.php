...
<div class="w-11/12 xl:w-1/5 min-h-[309px] 2xl:h-[309px] bg-white rounded-lg shadow dark:bg-gray-800 m-3 float-left justify-center">
<!-- <div class="w-full xl:w-1/5 min-h-[309px] bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 float-left"> -->
<h2 class="semi_pie ">Pie chart sensor1</h2>
  ...
  <!-- Line Chart -->
  <div style="margin:0 auto;" class="py-6" id="pie-chart" ></div>
