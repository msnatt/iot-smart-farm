...
<?php
  ...
  include_once("includes/fn/pg_connect.php");
    ...
    $db = pg_connect( "$host $port $dbname $credentials"  );
      ...
      $datax_id = "";
      if(isset($_GET['datax_id']) && $_GET['datax_id']!=""){
        $datax_id = $_GET['datax_id'];
      }

      $sql_sel_group  = "SELECT datax_id, datax_name,status
  ...
  <script>
    ...
    function edit_group(){
      ...
      var dataString = 'data_group_manage_type=4'+'&group_name='+group_name+'&group_id='+group_id+"&branch_id="+branch; //ค่าที่จะส่งไปพร้อมตัวแปร
          $.ajax ({
              ...
              if(jsonData.ret=='101'){
                ...
                window.location.replace("manage_data.php");
